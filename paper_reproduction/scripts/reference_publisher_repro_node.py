...
"""Reference publisher for paper_reproduction (SSI-MPC source unchanged).

Fixes a race when GP/RDRv MPC starts slowly: latch the reference topic and hold
mpc_busy until the controller reports busy after accepting the trajectory.
"""
...
class ReferenceGenerator:
    ...
    def __init__(self):
        ...
        status_topic = "busy"
        reference_pub = rospy.Publisher(reference_topic, ReferenceTrajectory, queue_size=1, latch=True)
    ...
    def _mark_trajectory_sent(self) -> None:
        self._hold_busy = True
        self.mpc_busy = True
